...
hello_clojurescript.photoSrcs = function photoSrcs(b) {
  return cljs.core.truth_(function() {
    var c = b.photos;
    return cljs.core.truth_(c) ? 0 < b.photos.length : c
  }()) ? goog.array.map(b.photos, photoSrcs) : b["photo-url-1280"]
};
hello_clojurescript.myTumblrData = cljs.core.atom.call(null, []);
hello_clojurescript.handle_json_resp = function(a) {
  return cljs.core.swap_BANG_.call(null, hello_clojurescript.myTumblrData, function() {
    return goog.array.flatten(goog.array.map(a.posts, hello_clojurescript.photoSrcs))
  })
};
hello_clojurescript.get_tumblr_data = function() {
  return(new goog.net.Jsonp("http://simloovoo.tumblr.com/api/read/json")).send({type:"photo", num:50, start:0}, hello_clojurescript.handle_json_resp, function() {
    return cljs.core.List.EMPTY
  }, "cacheplz")
};
