...
yepnope([{
	...
	complete: function(){
	 	...
	 	yepnope([
	 		...
	 		{test: window.jQuery, nope: 'http://clojurescript.blkblnkt.com/js/vendor/jquery-1.8.3.js'},
	 		{test: window._, nope: 'http://clojurescript.blkblnkt.com/js/vendor/lodash-1.0.0-rc3.js'}
	 	]);
	}},{
	...
	complete: function(){
		yepnope({test: window.Backbone, nope: 'http://clojurescript.blkblnkt.com/js/vendor/backbone-0.9.10.js'});
	}},{
	...
	load: 'http://clojurescript.blkblnkt.com/js/cljs.simple.js',
	complete: function(){
