  ...
  var a = function(a) {
    for(;;) {
      if(cljs.core.truth_(function() {
        ...
        console.log(cljs.core.first.call(null, a)), a = cljs.core.next.call(null, a)
      }else {
        return null
      }
    }
...
simCljs.app.photoSrcs = function photoSrcs(b) {
  return cljs.core.truth_(function() {
    var c = _.isArray(b.photos);
    return cljs.core.truth_(c) ? 0 < b.photos.length : c
  }()) ? goog.array.map(b.photos, photoSrcs) : b["photo-url-1280"]
};
simCljs.app.myTumblrData = cljs.core.atom.call(null, []);
...
simCljs.app.insertPhotos = function insertPhotos(b) {
  var c = cljs.core.js__GT_clj.call(null, b), b = jayq.core.$.call(null, cljs.core.apply.call(null, cljs.core.str, cljs.core.PersistentVector.fromArray(['<img src="', cljs.core.first.call(null, c), '" />'], !0)));
  return cljs.core.truth_(cljs.core.not_empty.call(null, c)) ? (simCljs.app.insertPhoto.call(null, b), setTimeout(function() {
    return insertPhotos.call(null, cljs.core.rest.call(null, c))
...
simCljs.app.handle_json_resp = function(a) {
  ...
  simCljs.app.safeLog.call(null, a);
  simCljs.app.safeLog.call(null, cljs.core.swap_BANG_.call(null, simCljs.app.myTumblrData, function() {
    return cljs.core.truth_(a.posts) ? goog.array.flatten(goog.array.map(a.posts, simCljs.app.photoSrcs)) : null
  }));
...
simCljs.app.get_tumblr_data = function() {
  return(new goog.net.Jsonp("http://simloovoo.tumblr.com/api/read/json")).send({type:"photo", num:50, start:0}, simCljs.app.handle_json_resp, function() {
    return cljs.core.List.EMPTY
  }, "cacheplz")
};
